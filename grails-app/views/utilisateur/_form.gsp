...
<%--  DONNES PERSONNELLES  --%>
<fieldset>
	<legend><g:message code="utilisateur.info.perso"  /></legend>
...
<%--  ADRESSE DOMICILE  --%>
<fieldset>
	<legend><g:message code="utilisateur.adresseDomicile"  /></legend>
...
<%--  ADRESSE DESTINATION  --%>
<fieldset>
	<legend><g:message code="utilisateur.adresseDestination"  /></legend>
...
<sec:ifAllGranted roles="ROLE_PROFIL_ADMIN">
	<fieldset>
		<legend><g:message code="utilisateur.etat.compte"  /></legend>
